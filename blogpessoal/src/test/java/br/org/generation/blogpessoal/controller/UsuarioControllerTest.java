...
public class UsuarioControllerTest {
	...
	@Test
	@Order(1) //Comando pra mandar testar primeiro esse
	...
	//Desafio - Teste de atualização de usuário
	@Test
	@Order(4) 
	...
	public void deveAtualizarUmUsuario() {
		...
		Optional<Usuario> usuarioCreate = usuarioService.cadastrarUsuario(new Usuario(0L, 
				"Juliana Macedo", "juliana_macedo@email.com.br", "juliana123"));

			Usuario usuarioUpdate = new Usuario(usuarioCreate.get().getId(), 
				"Juliana Macedo Silva", "juliana_macedo@email.com.br", "juliana123");
